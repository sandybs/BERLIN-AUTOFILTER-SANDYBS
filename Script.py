...
<blockquote>🌿 Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ : <a href='https://t.me/SCExplorelinks'>Exᴘʟᴏʀᴇᴍᴏᴠɪᴇs</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ Mʏ ɴᴀᴍᴇ : Bᴇʀʟɪɴ\n‣ Cʀᴇᴀᴛᴏʀ : <a href='https://t.me/SCExplorelinks'>Exᴘʟᴏʀᴇᴍᴏᴠɪᴇs</a>\n‣ Lɪʙʀᴀʀʏ : Pʏʀᴏɢʀᴀᴍ\n‣ Lᴀɴɢᴜᴀɢᴇ : Pʏᴛʜᴏɴ\n‣ Dᴀᴛᴀ Bᴀsᴇ : Mᴏɴɢᴏ Dʙ\n‣ Hᴏsᴛᴇᴅ ᴏɴ  : Kᴏʏᴇʙ\n‣Bᴜɪʟᴅ Sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- Create Your Bot ◉› :<blockquote><a href="https://t.me/Jailadmin_bot">𝗝ᴀɪʟ 𝗔ᴅᴍɪɴ 𝗕ᴏᴛ</a></blockquote>
...
/set_time_3 {seconds} Sᴇᴛ ᴛʜᴇ ᴛʜɪʀᴅ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴛɪᴍᴇ
--------------Verify On Off------------
/verifyoff {verify.off code} - off verification <a href="https://t.me/Jailadmin_bot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/Jailadmin_bot">Example</a>
--------------Set Tutorial-------------
/set_tutorial - set verification tutorial 
-------------Set Log Channel-----------
--> ᴀᴅᴅ ʟᴏɢ ᴄʜᴀɴɴᴇʟ ʙʏ ᴛʜɪs ꜰᴏʀᴍᴀᴛ & ᴍᴀᴋᴇ sᴜʀᴇ ʙᴏᴛ ɪs ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ʟᴏɢ ᴄʜᴀɴɴᴇʟ 👇
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/Jailadmin_bot">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/SCExplorelinks">ᴀᴅᴍɪɴ</a></b>"""
